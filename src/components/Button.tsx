...
const body_Font = localFont({
  src: "../app/fonts/Sora/fonts/Sora-Regular.ttf",
});
...
const Button: React.FC<ButtonProps> = ({
  ...
  const commonClasses = `relative hover:text-white  overflow-hidden group ${backgroundColor} ${color} ${border} ${body_Font.className} px-[34px] py-[14px]  text-[13px] sm:text-[14px]  rounded-[8px] cursor-pointer text-center ${additionalClasses}`;
