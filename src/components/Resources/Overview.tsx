...
import SubscribeForm from "../Insight/SubscribeForm";
...
function Resources() {
    ...
    const fetchInsights = async () => {
      ...
      try {
       ...
       const blogsData = querySnapshot.docs
         ...
         // @ts-ignore
         .filter((blog) => blog.resources === true) // Ensure insights exists and is a boolean
  ...
  return (
    ...
    >
      {loading && (
        <div className="absolute inset-0 flex- hidden items-center justify-center bg-white bg-opacity-50 z-50">
      ...
      <div className="container1 min-h-screen py-[154px] xl:py-[200px]  text-p_black">
        <div>
          <div>
            ...
            <Header3 className="mb-8 text-p_green">Resources Hub </Header3>
